...
public class Robot
{
    public int initialXCoord, initialYCoord;
    public int xCoord, yCoord;
    
    private Random generator;
    private Point currentLocation, initialLocation;
    ...
    /**
     * Gets the distance of the Robot from the starting point
     */
    public double getDistanceFromStart()
    {
        return currentLocation.distance(initialLocation);
    }
}
