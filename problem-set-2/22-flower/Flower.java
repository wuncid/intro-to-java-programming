...
/**
 * Flower with four pink petals and a yellow center on a stem.
 */
public class Flower
{
    private int x;
    ...
    /**
     * Constructs a flower with upper left-hand corner coordinates x and y
     * 
     * @param theX the x coordinate of upper left-hand corner
     * @param theY the y coordinate of upper left-hand corner
     */
