...
{
    /**
     * Gets the number of strings that starts with the target letter
     * 
     * @param   text    the array list to process
     * @param   target  the desired letter
     * @return  the count of strings starting with the targer letter
     */
    public int getCount(ArrayList<String> text, String target)
    {
         ...
         {
             if (word.substring(0,1).equals(target))
             {
                 count++;
             }
         }
